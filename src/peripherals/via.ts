...
export enum VIAInterruptSource {
  CA2 = 0x01,
  CA1 = 0x02,
  SHIFT_REGISTER = 0x04,
  CB2 = 0x08,
...
export class VIA65C22Implementation implements VIA65C22 {
  // Register addresses (offsets from base)
  private static readonly REG_ORB_IRB = 0x00;    // Output/Input Register B
  private static readonly REG_ORA_IRA = 0x01;    // Output/Input Register A
  private static readonly REG_DDRB = 0x02;       // Data Direction Register B
  private static readonly REG_DDRA = 0x03;       // Data Direction Register A
  private static readonly REG_T1C_L = 0x04;      // Timer 1 Counter Low
  private static readonly REG_T1C_H = 0x05;      // Timer 1 Counter High
  private static readonly REG_T1L_L = 0x06;      // Timer 1 Latch Low
  private static readonly REG_T1L_H = 0x07;      // Timer 1 Latch High
  private static readonly REG_T2C_L = 0x08;      // Timer 2 Counter Low
  private static readonly REG_T2C_H = 0x09;      // Timer 2 Counter High
  private static readonly REG_SR = 0x0A;         // Shift Register
  private static readonly REG_ACR = 0x0B;        // Auxiliary Control Register
  private static readonly REG_PCR = 0x0C;        // Peripheral Control Register
  private static readonly REG_IFR = 0x0D;        // Interrupt Flag Register
  private static readonly REG_IER = 0x0E;        // Interrupt Enable Register
  private static readonly REG_ORA_IRA_NH = 0x0F; // Output/Input Register A (no handshake)

  // Internal state
  private portAData: number = 0x00;
  private portBData: number = 0x00;
  private portADirection: number = 0x00;  // 0 = input, 1 = output
  private portBDirection: number = 0x00;
  
  private timer1Counter: number = 0;
  private timer1Latch: number = 0;
  private timer2Counter: number = 0;
  
  private shiftRegister: number = 0x00;
  private auxiliaryControlRegister: number = 0x00;
  private peripheralControlRegister: number = 0x00;
  private interruptFlagRegister: number = 0x00;
  private interruptEnableRegister: number = 0x00;
  
  private timer1Running: boolean = false;
  private timer2Running: boolean = false;
  ...
  private setInterruptFlag(source: VIAInterruptSource): void {
    this.interruptFlagRegister |= source;
  }

  private clearInterruptFlag(source: VIAInterruptSource): void {
    this.interruptFlagRegister &= ~source;
  }
