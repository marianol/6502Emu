...
exports.EmulatorBenchmark = void 0;
/**
...
class EmulatorBenchmark {
     ...
     * Mixed workload benchmark
     */
    async runMixedWorkloadBenchmark() {
     ...
     */
    async setupBenchmark(program, startAddress) {
        this.emulator.reset();
...
exports.EmulatorBenchmark = EmulatorBenchmark;
