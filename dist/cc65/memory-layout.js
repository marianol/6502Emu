...
exports.CC65Runtime = exports.CC65MemoryConfigurator = void 0;
/**
...
exports.CC65MemoryConfigurator = CC65MemoryConfigurator;
/**
 * CC65 Runtime Library Compatibility
 */
class CC65Runtime {
    constructor(layout, startupAddress = 0x0800) {
        this.layout = layout;
     ...
     */
    getSegmentForAddress(address) {
        return this.layout.segments.find(segment => address >= segment.start && address < segment.start + segment.size);
    }
    /**
...
exports.CC65Runtime = CC65Runtime;
//# sourceMappingURL=memory-layout.js.map